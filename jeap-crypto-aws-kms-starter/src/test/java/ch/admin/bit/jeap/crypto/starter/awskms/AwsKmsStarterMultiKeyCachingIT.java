...
@ActiveProfiles({"multi-key-test-caching", "aws-test"})
class AwsKmsStarterMultiKeyCachingIT extends AbstractAwsKmsIntegrationTestBase {
    ...
    void testEncryptionRoundtripAndSpringConfiguration() {
        ...
        byte[] encryptedBytes = dbCryptoService.encrypt(dbBlobV3Bytes);
        ...
        dbCryptoService.decrypt(encryptedBytes);
    ...
    private void assertCacheHitMissCounts(long encryptionCacheHitCount, long encryptionCacheMissCount,
        ...
        assertThat(encryptionCacheStats.hitCount())
                .isEqualTo(encryptionCacheHitCount);
        assertThat(encryptionCacheStats.missCount())
                .isEqualTo(encryptionCacheMissCount);
        KeyCacheStats decryptionCacheStats = cachingKeyManagementService.getDecryptionKeyCacheStats();
        assertThat(decryptionCacheStats.hitCount())
                .isEqualTo(decryptionCacheHitCount);
        assertThat(decryptionCacheStats.missCount())
                .isEqualTo(decryptionCacheMissCount);
    }
}
