...
- update jeap-spring-boot-vault-starter from 21.9.0 to 21.10.0
...
- update jeap-spring-boot-vault-starter from 21.8.0 to 21.9.0
...
- update jeap-spring-boot-vault-starter from 21.7.0 to 21.8.0
...
- update jeap-spring-boot-vault-starter from 21.6.0 to 21.7.0
...
- update jeap-spring-boot-vault-starter from 21.5.0 to 21.6.0
...
- update jeap-spring-boot-vault-starter from 21.4.0 to 21.5.0

## [7.4.0] - 2026-04-20
### Changed
- update jeap-spring-boot-vault-starter from 21.3.0 to 21.4.0
