...
- update jeap-spring-boot-vault-starter from 25.6.0 to 25.7.0
...
- update jeap-spring-boot-vault-starter from 25.4.0 to 25.5.0
...
### Changed
- Replaced LocalStack with Floci (floci.io) as AWS emulator in the integration tests
