...
* Ready-made helpers for encrypted database columns (JPA `AttributeConverter`) and S3 objects; the
  generic byte-array API integrates equally well with Kafka messages, the jEAP Process Archive
  Service, or any other persistence or messaging technology
